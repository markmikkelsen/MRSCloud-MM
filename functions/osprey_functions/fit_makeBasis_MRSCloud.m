...
function [BASIS] = fit_makeBasis_MRSCloud(folder, addMMFlag, sequence, editTarget, TE, localization, vendor)
...
elseif any(strcmp(sequence, {'HERMES','HERCULES','HERMES_GABA_GSH_EtOH'}))
...
% figure;
% plot(ppmWindow, real(refWindow), '.', ppmWindow, yGuess, ':', ppmWindow, yFit);
