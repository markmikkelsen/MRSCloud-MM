...
for ii = 1:length(MRS_opt)
    ...
    d3_edit1 = sim_evolve(d3_edit1, MRS_opt(ii).H, delays(2)/1e3);
    ...
    parfor (X = 1:length(MRS_opt(ii).x), MRS_opt.parallelize.workers)
        ...
        d3_x{X} = sim_evolve(d3_x{X}, MRS_opt(ii).H, delays(3)/1e3);
        d4_x{X} = sim_evolve(d4_x{X}, MRS_opt(ii).H, delays(3)/1e3);
        ...
        d3_x{X} = sim_evolve(d3_x{X}, MRS_opt(ii).H, delays(4)/1e3);
        d4_x{X} = sim_evolve(d4_x{X}, MRS_opt(ii).H, delays(4)/1e3);
    ...
    parfor (Y = 1:length(MRS_opt(ii).y), MRS_opt.parallelize.workers)
        ...
        d3_y{Y} = sim_evolve(d3_y{Y}, MRS_opt(ii).H, delays(5)/1e3);
        d4_y{Y} = sim_evolve(d4_y{Y}, MRS_opt(ii).H, delays(5)/1e3);
        ...
        d3_y{Y} = sim_evolve(d3_y{Y}, MRS_opt(ii).H, delays(6)/1e3);
        d4_y{Y} = sim_evolve(d4_y{Y}, MRS_opt(ii).H, delays(6)/1e3);
        ...
        d3_y{Y} = sim_evolve(d3_y{Y}, MRS_opt(ii).H, delays(7)/1e3);
        d4_y{Y} = sim_evolve(d4_y{Y}, MRS_opt(ii).H, delays(7)/1e3);
